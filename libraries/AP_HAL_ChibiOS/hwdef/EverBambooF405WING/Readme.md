# EverBambooF405WING Flight Controller

The EverBambooF405WING is a flight controller produced by [EverBamboo](https://shop355507434.taobao.com/?spm=pc_detail.30350276.shop_block.dshopinfo.64a27dd6xHWnFy).
...
![EverBambooF405WING](EverBambooF405WING.png)

## Wiring Diagram

![EverBambooF405WING Wiring](EverBambooF405WING_wiring.png)
...
The EverBambooF405Wing supports using its internal OSD using OSD_TYPE 1 (MAX7456 driver). External OSD support such as DJI or DisplayPort is supported using UART5 or any other free UART5. See :ref:`common-msp-osd-overview-4.2` for more info.

## PWM Output

The EverBambooF405Wing supports up to 12 PWM outputs (PWM12 is the serial LED output, by default). All outputs support DShot.
...
The EverBambooF405Wing does not have a built-in compass, but you can attach an external compass using I2C on the SDA and SCL pads.
...
## Loading Firmware
Firmware for these boards can be found at https://firmware.ardupilot.org in sub-folders labeled “EverBambooF405Wing”.

Initial firmware load can be done with DFU by plugging in USB with the
boot button pressed. Then you should load the "EverBambooF405Wing_bl.hex"
